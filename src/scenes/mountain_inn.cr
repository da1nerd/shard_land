...
struct Scenes::MountainInn < Scenes::BaseScene
  def description(state : State) : String
    ...
    The Inn keeper sits behind a desk, and a flight of stairs leading upstairs is on the east wall.
    ...
    "It'll be a new life for you, a new start. I have two rooms available." 
    He leads you upstairs. There is a room to the west facing the mountain and one to the east facing the valley.
    MSG
  end

  @[Override]
  def run(state : State)
    west Scenes::MountainSideRoom, "The room faces the mountain side"
    east Scenes::ValleySideRoom, "The room faces the valley"
  end
end
